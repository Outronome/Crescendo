          ...
          <div class="rounded-lg border border-[#649dad] bg-[#649dad] p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
              ...
              <div class="flex items-center justify-between md:order-3 md:justify-end">
                ...
                <div class="text-end md:order-4 md:w-32">
                  <p class="text-base font-bold text-gray-900 dark:text-white">€4,99</p>
                </div>
              </div>

              <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                <a href="#" class="text-base font-medium text-gray-900 hover:underline dark:text-white">idk - Highvyn, Taylor Shin</a>
