  ...
  <div class="mx-auto grid grid-cols-4  max-w-screen-xl px-4 2xl:px-0">
    <div class="mb-4 ">
      ...
      <div class="rounded-lg border border-gray-200 bg-[#85b2bf] p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">idk -
          Highvyn, Taylor Shin</a>
        ...
        <div class="mt-4 flex items-center justify-between gap-4">
          <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">€4,99</p>
