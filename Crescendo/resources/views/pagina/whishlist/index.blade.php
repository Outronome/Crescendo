<section class="bg-[#85b2bf] py-8 antialiased  md:py-12">
  @section('topbar')
    ...
    <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
      <div class="rounded-lg border border-gray-200 bg-[#85b2bf] p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
            <img class="mt-4 mx-auto h-full dark:hidden"
          ...
          <div class="mb-4 flex items-center justify-between gap-4">
            ...
            <div class="flex items-center justify-end gap-1">
              ...
              <button type="button" data-tooltip-target="tooltip-add-to-favorites"
                ...
                <svg class="h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="full"
                  viewBox="0 0 24 24">
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="pt-8">
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">iPad Pro
            13-Inch (M4): XDR Display, 512GB</a>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="pt-8">
          ...
          <a href="#"
            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Microsoft Xbox
            Series X 1TB Gaming Console</a>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6  shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="pt-8">
          ...
          <a href="#"
            class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Microsoft Surface
            Pro, Copilot+ PC, 13 Inch</a>
            ...
            <div class="grid grid-cols-2 gap-4 md:grid-cols-3" id="brand" role="tabpanel" aria-labelledby="brand-tab">
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center">
                  ...
                  <label for="brother" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Brother (176)
                  </label>
                </div>
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center">
                  ...
                  <label for="foxconn" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Foxconn (234)
                  </label>
                </div>
              ...
              <div>
                ...
                <div class="space-y-2">
                  ...
                  <div class="flex items-center">
                    ...
                    <label for="over-3-kg" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Over 3 kg
                    </label>
                  </div>
                </div>
              </div>
