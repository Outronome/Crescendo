            ...
            <section class="w-full  items-center">
                <div class="max-w-screen-xl flex items-center justify-between mx-auto relative ">
                    ...
                    <div class="relative w-full bg-white shadow-md dark:bg-[#649dad] sm:rounded-lg ">
                        <div
                            class="flex flex-col items-center w-full justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                            ...
                            <div
                                ...
                                <div class="flex items-center w-full space-x-3 md:w-auto">
                                    ...
                                    <button id="filterDropdownButton" data-dropdown-toggle="filterDropdown"
                                        class="flex items-center justify-center w-full px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg md:w-auto focus:outline-none hover:bg-gray-100 hover:text-primary-700   focus:text-white  dark:bg-[#649dad] dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-[#649dad]"
                                        type="button">
                                        ...
                                        <svg class="-mr-1 ml-1.5 w-5 h-5 text-white" fill="currentColor"
                                    ...
                                    <div id="filterDropdown"
                                        class="z-10 hidden w-48 p-3 bg-white rounded-lg shadow dark:bg-[#649dad]">
                                        ...
                                        <ul class="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                                            <li class="flex items-center">
                                                <input id="apple" type="checkbox" value=""
                                                    class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-primary-500  dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500" />
                                                <label for="apple"
