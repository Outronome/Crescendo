    ...
    <div class=" h-screen w-screen p-4">
        ...
        <div class=" p-4 w-5/7 h-3/4 flex items-center justify-center mx-[50px] mt-28 bg-[#649dad] rounded-[15px]">
            ...
            <div class=" h-full w-1/4  p-4 flex flex-col  rounded-[15px]">
                ...
                <input class="  border border-black rounded-[5px] mt-[10px] pl-[5px] mb-[10px] bg-[#85b2bf]" type="text"
                ...
                <button class="w-full border border-black rounded-[15px] mt-auto font-bold">Pesquisar</button>
            </div>
                    ...
                    <div class="bg-[#85b2bf] p-8 rounded-lg shadow-md w-80 h-5/6">
                        ...
                        <div class="mt-6 flex justify-center items-center">
                            <button class="p-3 rounded-full bg-[#85b2bf] shadow shadow-black  focus:outline-none">
                                <svg width="64px" height="64px" viewBox="0 0 24 24" class="w-4 h-4 text-gray-600"
                            ...
                            <button class="p-4 rounded-full bg-[#85b2bf] shadow shadow-black  focus:outline-none mx-4">
                                <svg width="64px" height="64px" viewBox="0 0 24 24" class="w-6 h-6 text-gray-600"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
