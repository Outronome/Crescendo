...
<div class="content-evenly shrink  w-full mt-8  ">
            <div class=" bg-white px-4 pr-6">
                <div class="flex justify-between items-center pb-8 pt-4">
                    <div class="flex-1">
                        <input placeholder="Nome" id="novo_nome" wire:key="input-novo_nome" class="w-full p-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 " type="text" wire:model.defer="nome" />
                        
                            
                    </div>
                    <button  type="submit"  class="bg-green-600  ml-6 p-2 rounded-full px-4 text-base font-semibold text-white " wire:click="adicionar()">Adicionar Tema</button>
                </div>
            </div>
            <!--Só falta quando estiver finalizado a parte do componente com data e
            tudo de organizar a tabela por ordem ascendente e descente-->
            <div class="  mt-2 overflow-x-auto " style="height: 80vh;">
                <table class="table-auto w-full text-center relative" >
                    <thead class="">
                        <tr>
                            <th class="sticky top-0 px-4 py-2 bg-white z-10 text-lg font-bold w-1/12">
                                <input placeholder="Pesquisar..." class=" p-2 border border-gray-200 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 " type="text" wire:model.live="pesquisa" />
                            </th>
                            <th class="sticky top-0 px-4 py-2 bg-white z-10 text-lg font-bold">Nome</th>
                            <th class="sticky top-0 px-4 py-2 bg-white z-10 text-lg font-bold">Estado</th>
                            <th class="sticky top-0 px-4 py-2 bg-white z-10 text-lg font-bold">Data</th>
                            <th class="sticky top-0 px-4 py-2 bg-white z-10 text-lg font-bold">Ações</th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($temas as $index => $tema)
                            <tr x-data="{ nome: '{{ $tema->nome }}' }">
                                ...
                                <td>
                                    ...
                                    @else
                                    <p class="transform-gpu hover:scale-125">
                                        {{$tema->nome}}
                                    </p>
                                    @endif
                                ...
                                <td class="flex items-center justify-evenly">
                                  @if (isset($editar[$index]) && $editar[$index])
                                          <button type="button"  wire:key="tema-{{ $tema->id }}" wire:click="guardarTema({{$index}})">
                                              <img class="w-6 mt-2 transform-gpu hover:scale-125" src="{{asset('/assets/img/guardar.webp')}}"/>
                                          </button>
                                  @else
                                          <button type="button" wire:click="editarTema({{$index}})">
                                              <img class="w-6 mt-2 transform-gpu hover:scale-125" src="{{asset('/assets/img/editar.png')}}"/>
                                          </button>
                                  @endif
              ...
              <div class="overflow-x-auto">
                  <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                      <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                          <tr>
                              <th scope="col" class="px-4 py-4">Nome do Tema</th>
                      ...
                      @foreach ($temas as $tema)
                          <tr class="border-b dark:border-gray-700">
                              <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$tema->nome}}</th>
                              <td class="px-4 py-3 flex items-center justify-end">
                                  ...
                                  <div id="apple-imac-27-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                      <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-button">
                                          <li>
                                              <button wire:key="tema-{{ $tema->id }}" type="button" wire:click="editar" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                          ...
                                          <li>
                                              <button wire:key="temaelim-{{ $tema->id }}" type="button" data-modal-target="readProductModal" data-modal-toggle="readProductModal" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
                                                  <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
