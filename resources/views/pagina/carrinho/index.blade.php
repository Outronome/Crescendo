  ...
  <div class="space-y-6">
    @forelse ($itens as $item)
        @php
            $musica = $item->musica;
        @endphp
        <div class="rounded-lg border border-[#649dad] bg-[#649dad] p-4 shadow-sm  md:p-6">
            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                ...
                <div class="flex items-center justify-between md:order-3 md:justify-end">
                    <div class="flex items-center">
                        ...
                        <input type="text" readonly
                            class="w-10 border-0 bg-transparent text-center text-sm font-medium text-gray-900 "
                ...
                <div class="w-full flex-1 space-y-4 md:order-2 md:max-w-md">
                    <p class="text-base font-medium text-gray-900 ">{{ $musica->titulo }}</p>
