            ...
            <div class="rounded-lg border border-gray-200 bg-[#85b2bf] p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                ...
                <div class="pt-8">
                    <div class="mb-4 flex items-center justify-between gap-4">
                        ...
                        <button type="button" class="align-center items-center rounded-lg bg-red-600 px-2.5 py-2.5  font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-300" wire:click="removeFromWishlist({{ $musica->id }})">
                            <svg class=" h-5 w-5 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
