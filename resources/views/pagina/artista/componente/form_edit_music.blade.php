    ...
    <div class="bg-white rounded-lg p-6 w-full max-w-lg">
      ...
      <form class="space-y-4">
        ...
        <div>
          ...
          <input type="text" id="title" wire:model="novoTitulo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Nome da musica" required>
        </div>
        <div>
        ...
        <div class="flex justify-end space-x-2">
          ...
          <button type="button" wire:click="editarMusica" class="text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg text-sm px-5 py-2.5 text-center">Cancel</button>
        </div>
      </form>
    </div>
  </div>