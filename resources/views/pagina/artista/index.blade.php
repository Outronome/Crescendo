<section class="py-8 antialiased md:py-8">
  ...
  <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
    ...
    <div class="py-4 md:py-8">
      ...
      <div class="w-full bg-white border border-black rounded-lg shadow-lg ">
        <div class="sm:hidden">
          <label for="tabs" class="sr-only">Select tab</label>
          <select id="tabs"
            class=" border-0 border-b border-black text-gray-900 text-sm rounded-t-lg focus:ring-white  block w-full p-2.5 ">
            <option>Musicas</option>
            <option>Blog</option>
            <option>Ultimas Vendas</option>
          </select>
        </div>
        <ul
          class="hidden text-sm font-medium text-center text-gray-500 rounded-lg sm:flex  rtl:divide-x-reverse"
          id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
          <li class="w-full">
            <button id="stats-tab" data-tabs-target="#stats" type="button" role="tab" aria-controls="stats"
              aria-selected="true"
              class="text-white inline-block w-full p-4 rounded-ss-lg bg-[#66c6ba] hover:bg-gray-100 focus:outline-none ">Musicas</button>
          </li>
          <li class="w-full">
            <button id="about-tab" data-tabs-target="#about" type="button" role="tab" aria-controls="about"
              aria-selected="false"
              class="text-white inline-block w-full p-4 bg-[#66c6ba] hover:bg-gray-100 focus:outline-none ">Blog</button>
          </li>
          <li class="w-full">
            <button id="faq-tab" data-tabs-target="#faq" type="button" role="tab" aria-controls="faq"
              aria-selected="false"
              class="text-white inline-block w-full p-4 rounded-se-lg bg-[#66c6ba] hover:bg-gray-100 focus:outline-none ">Ultimas
              Vendas</button>
          </li>
        </ul>
        <div id="fullWidthTabContent" class="flex-col border-t  ">
          <div class="flex-col hidden p-4 bg-[#66c6ba]  md:p-8 " id="stats" role="tabpanel"
            aria-labelledby="stats-tab">
            
            <livewire:Pagina.Artista.Componente.Musica>

          </div>
          <div class="hidden p-4 bg-white rounded-lg md:p-4 " id="about" role="tabpanel" aria-labelledby="about-tab">
            <livewire:blog />
          </div>
    ...
    <div class="hidden p-4 bg-white rounded-lg " id="faq" role="tabpanel"
      ...
      <div class="rounded-lg border border-gray-200 bg-gray-50 p-4  md:p-8">
        ...
        <div
          class="flex flex-wrap items-center gap-y-4 border-b border-gray-200 pb-4  md:pb-5">
