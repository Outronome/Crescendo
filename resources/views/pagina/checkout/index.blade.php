    ...
    <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
      <div class="min-w-0 flex-1 space-y-8">
        <div class="space-y-4 p-5">
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Purchase Details</h2>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div class="flex items-center">
                <button id="dropdown-phone-button-3" data-dropdown-toggle="dropdown-phone-3"
                  ...
                  <svg fill="none" aria-hidden="true" class="me-2 h-4 w-4" viewBox="0 0 20 15">
                    <rect width="19.6" height="14" y=".5" fill="#FF0000" />
                    <rect width="9.8" height="14" y=".5" fill="#006600" />
                    <circle cx="10" cy="7.5" r="2.5" fill="white" stroke="black" stroke-width="0.3" />
                    <circle cx="10" cy="7.5" r="1.2" fill="red" />
                  </svg>
                  +351
            ...
            <div>
              ...
              <input type="text" id="vat_number"
                class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500"
                placeholder="PT123123123" required />
            </div>
              ...
              <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                ...
                <div
                  ...
                  <div class="flex items-start">
                    ...
                    <div class="ms-4 text-sm">
                      <label for="pay-on-delivery" class="font-medium leading-none text-gray-900 dark:text-white"> MB
                        Way </label>
                      <p id="pay-on-delivery-text" class="mt-1 text-xs font-normal text-gray-500 dark:text-gray-400">Add
                        your phone number</p>
                    </div>
                  </div>
      ...
      <div class="mt-6 pt-16 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
        <div class="flow-root">
